...
{
    [Tooltip("in ms")] [SerializeField] float Xspeed = 20f;
    [Tooltip("in m")] [SerializeField] float Yspeed = 20f;
    ...
    void Update()
    {
        float XThrow = CrossPlatformInputManager.GetAxis("Horizontal"); // getting the current axis
